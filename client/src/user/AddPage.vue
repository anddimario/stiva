        ...
        <div v-if="me.userRole === 'admin'">
          ...
          <form @submit.prevent="handleSubmit">
              ...
              <div class="form-group">
                  ...
                  <input type="text" v-model="user.userRole" v-validate="'required'" name="userRole" class="form-control" :class="{ 'is-invalid': submitted && errors.has('userRole') }" />
                  <div v-if="submitted && errors.has('userRole')" class="invalid-feedback">{{ errors.first('userRole') }}</div>
              </div>
              <div class="form-group">
            ...
            <p v-if="added.done">User added</p>
        </div>
    </div>
</template>
